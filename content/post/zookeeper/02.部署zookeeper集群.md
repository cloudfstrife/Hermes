---
title: "构建Zookeeper集群"
date: 2018-12-19T15:15:00+08:00
categories:
- Zookeeper
tags:
- zookeeper
...
| IP地址 | 主机名 | 操作系统 |
|:---:|:---:|:---:|
|192.168.159.130|debian-server-001| debian 9.6 |
|192.168.159.131|debian-server-002| debian 9.6 |
|192.168.159.132|debian-server-003| debian 9.6 |
...
```
192.168.159.130	debian-server-001
192.168.159.131	debian-server-002
192.168.159.132	debian-server-003
```
...
```
sudo cp /opt/zookeeper-3.4.13/conf/zoo_sample.cfg /opt/zookeeper-3.4.13/conf/zoo.cfg 
```
...
server.1=debian-server-001:2888:3888
server.2=debian-server-002:2888:3888
server.3=debian-server-003:2888:3888
